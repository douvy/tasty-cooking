...
function filterRecipes() {
    ...
    if (visibleCount === 0) {
        if (!noResultsMsg) {
            ...
            noResultsMsg.className = 'absolute inset-0 flex flex-col items-center justify-center text-center';
            noResultsMsg.innerHTML = '<p class="text-white text-2xl font-windsor-bold">No recipes match the selected filters</p><p class="mt-2 text-base text-gray">Try removing some tags to see more results</p>';
