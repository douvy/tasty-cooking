...
function addTagLabel(tag) {
    ...
    tagLabel.className = 'inline-flex items-center px-3.5 py-1.5 rounded-sm text-sm font-medium bg-[#33353c] capitalize text-white mr-2 mb-1 cursor-pointer hover:bg-[#3b3d44]';
