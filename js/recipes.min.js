...
document.querySelectorAll('[data-tag]').forEach(function(element) {
    element.addEventListener('click', function(event) {
        ...
        if (event.target.classList.contains('bg-[#222616]')) {
            event.target.classList.remove('bg-[#222616]', 'text-white');
            removeTagLabel(tag);
        } else {
            event.target.classList.add('bg-[#222616]', 'text-white');
            addTagLabel(tag);
        }
...
function addTagLabel(tag) {
    ...
    tagLabel.className = 'inline-flex items-center px-2.5 py-1 sm:py-2 text-sm rounded-sm bg-[#2e3523] capitalize text-white mt-2 mr-2 sm:mr-2 cursor-pointer hover:bg-light-gray';
    ...
    if (query) {
        ...
        if (filteredRecipes.length) {
            ...
            filteredRecipes.forEach(recipe => {
                ...
                div.className = 'px-4 py-2 cursor-pointer hover:bg-[#25272c] flex items-center space-x-2 border-b border-[#2f3525]';
