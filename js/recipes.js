...
function addTagLabel(tag) {
    ...
    tagLabel.className = 'inline-flex items-center px-3 py-1 rounded-sm text-xs bg-[#141519] capitalize text-light-grayish-orange mr-2 cursor-pointer hover:bg-light-gray';
